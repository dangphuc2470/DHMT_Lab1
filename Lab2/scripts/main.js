...
function getBox(w, h, d) {
    ...
    var material = new THREE.MeshBasicMaterial({ color: 0xA03F28 });
...
function getSphere(size) {
    ...
    var material = new THREE.MeshBasicMaterial({ color: 0xF9E09F });
    var mesh = new THREE.Mesh(geometry, material);
    return mesh;
}
...
function getPrism(height, radius) {
    ...
    var material = new THREE.MeshBasicMaterial({ color: 0x496727 });
    var mesh = new THREE.Mesh(geometry, material);
    return mesh;
}
